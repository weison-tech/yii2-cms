...
/* @var $searchModel core\modules\home\models\search\LinkSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('HomeModule.base', 'Links');
...
<div class="link-index">
    ...
    <p>
        <?= Html::a(Yii::t('HomeModule.base', 'Create Link'), ['create'], ['class' => 'btn btn-success btn-flat']) ?>
    </p>
    <?= GridView::widget([
        ...
        'columns' => [
            [
                ...
                'content' => function ($model) {
                    return $model->img ? Html::img($model->img->getPreviewImageUrl(50, 50),
