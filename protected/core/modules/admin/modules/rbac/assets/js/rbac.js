...
function search(target) {
    ...
    var groups = {
        role: [$('<optgroup label="' + _opts.label.label_roles + '">'), false],
        permission: [$('<optgroup label="' + _opts.label.label_permission + '">'), false],
        route: [$('<optgroup label="' + _opts.label.label_routes + '">'), false],
    };
