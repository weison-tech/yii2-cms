...
$this->title = Yii::t('ProductsModule.base', 'Industry Categories');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="category-index">

    <p>
        <?= Html::a("<i class='fa fa-angle-double-down'></i> <span>" . Yii::t('ProductsModule.base',
                'Open All') . '</span>', 'javascript:void(0)', ['class' => 'btn btn-info btn-flat', 'id' => 'toggle']) ?>
        <?= Html::a(Yii::t('ProductsModule.base', 'Create Category'), ['create'],
    ...
    $(function () {
        $("#toggle").click(function () {
            ...
            if (flg.hasClass('fa-angle-double-down')) {
                var close = "<?=Yii::t('ProductsModule.base', 'Close All')?>";
                ...
                var open = "<?=Yii::t('ProductsModule.base', 'Open All')?>";
