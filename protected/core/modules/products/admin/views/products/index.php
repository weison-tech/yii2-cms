...
$this->title = Yii::t('ProductsModule.base', 'Products');
...
<div class="products-index">
    ...
    <p>
        <?= Html::a(Yii::t('ProductsModule.base', 'Create Products'), ['create'], ['class' => 'btn btn-success btn-flat']) ?>
    </p>
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'value'=> function ($model) {
                    return $model->industry ? $model->industry->name : '-';
                },
                'format' => 'raw',
            ],
            'name',
